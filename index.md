...
Here is a whole-song generation example of 40 bars, where <font color="#e03c34">red</font> notes indicate the melody and <font color="#2B7ADB">blue</font> notes indicate the accompaniment. We also use different background colors to indicate phrase division of its music form, where we see a clear chorus-verse structure.
...
This whole piece is generated by the model in a *top-down* fashion. First, it generates the music ***Form***, which involves **key and phrase division** (the top-level music language introduced in Section 3.1 of the paper). The following *Form* visualization indicates a piece in Ab major (shown as the tonic key in <font color="#e03c34">red</font> and the scale in <font color="#aaa">grey</font>) with the phrase division of **i**4**A**4**A**4**B**8**b**4**A**4**B**8**o**4 (4-measure intro, 4-measure phrase A, etc., shown as the background colors).
...
Next, based on the *Form* above, the model generates ***Counterpoint***, which involves **reduced melody and simplified chord** (the 2nd-level music language). This level of language shows phrase development and structure, including phrase similarity, cadence of phrases using harmony and melody.
<section class="vis type1">
...
Then, based on the *Form* and *Counterpoint* above, the model generates ***Lead Sheet***, which involves **lead melody and chord** (the 3rd-level music language). This level of language shows the realization of the actual lead melody and harmony.
<section class="vis type1">
...
The model can generate ***Accompaniment*** in a variety of styles:
<section class="center-stuff alone">
