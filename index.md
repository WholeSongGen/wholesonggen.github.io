...
Here is a whole-song generation example of 40 bars, where <font color="#e03c34">red</font> notes indicate the melody and <font color="#2B7ADB">blue</font> notes indicate the accompaniment. We also use different colors to indicate phrase division of its music form, where we see a clear chorus-verse structure.
...
<button id="toggleButton" class="btn">Toggle Score</button>
<div class="center-stuff">
<img id="unfoldImage" src="/img/score_annotation.jpeg" style="display: none; width: 80%; margin-bottom: 30px">
</div>
...
Moreover, the generation can be controlled by given chord progressions. Here are the variations conditioned on a sequence of Eb major chords.
<section class="center-stuff alone">
...
Based on the same *Form* as in (in-page link) and *Counterpoint* as follows:
...
Different *Lead Sheet* variations can be generated:
<section class="center-stuff alone">
...
Based on the same *Form* as in (in-page link), *Counterpoint* as <a href="#fig6-a">here</a>, and *Lead Sheet* as follows:
<div class="center-stuff">
<section class="vis">
...
Different *Accompaniment* variations can be generated:
<section class="center-stuff alone">
